...
- i want to always use spec-style tests.
- i want my test descriptions to read like user stories and not like implementation details.
- i want my tests to focus on behavior and not implementation details.
- i want to ensure that my tests have valuable assertions for each behavior in the module under test.
